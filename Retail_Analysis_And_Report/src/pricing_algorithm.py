...
def calculate_recommended_price(row):
    ...
    # ---------------------------------------------------
    # Step 1: Calculate Base Price (Target Margin)
    # ---------------------------------------------------
    ...
    adjusted_price *= (1 + vel_factor)

    # ---------------------------------------------------
    # Step 5: Factor 4 – Advertising Efficiency (ACOS)
    # ---------------------------------------------------
    acos = row['Avg_ACOS']
    ...
    adjusted_price *= (1 + acos_factor)

    # ---------------------------------------------------
    # Step 6: Factor 5 – Returns Impact (-3% to +10%)
    # ---------------------------------------------------
    ...
    adjusted_price *= (1 + return_factor)
    ...
    # ---------------------------------------------------
    # Step 8: Validate Minimum Acceptable Margin
    # ---------------------------------------------------
